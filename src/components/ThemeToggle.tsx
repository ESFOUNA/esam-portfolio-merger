  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {theme === 'light' ? (
            <Moon className="h-5 w-5 text-gray-700 dark:text-gray-200 transition-colors group-hover:text-primary" />
          ) : (
            <Sun className="h-5 w-5 text-gray-700 dark:text-gray-200 transition-colors group-hover:text-primary" />
          )}
        </motion.div>
